...
async function main() {
  await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/milestone', { useNewUrlParser: true, useUnifiedTopology: true });
  ...
  const badge = new Badge({
    ...
    criteria: { type: 'pass_quiz', quizId: String(quiz._id), minPercentage: 70 }
  });
  await badge.save();
